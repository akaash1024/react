...
export const FetchRQ = () => {
  ...
  const { data, isPending, isError, error } = useQuery({
    queryKey: ["posts", id, pageNumber], // useState
    queryFn: () => fetchPosts(pageNumber), // useEffect
    placeholderData: keepPreviousData,
    
    // ? gcTime: 1000,     // * do garbage collection after every 1sec. .
    // ? staleTime: 1000, // * make sure for how long your fetched data will be fresh and once stale it refetch the data again ... .
